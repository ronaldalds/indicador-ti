...
class Chamado(models.Model):
    id = models.CharField(primary_key=True, max_length=11, help_text="ex: 0923-000052")
    ...
    total_horas_1_2_atendimento_str = models.CharField(max_length=12, help_text="ex: 0000:04:00")
    ...
    def save(self, *args, **kwargs):
        if self.total_horas_1_2_atendimento_str:
            ...
            self.total_horas_1_2_atendimento = horas + minutos / 60 + segundos / 3600
